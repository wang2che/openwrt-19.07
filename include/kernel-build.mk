...
#	cp /home/wangyb/sda3/linux-4.14.98/.config $(LINUX_DIR)/.config
#	cp /home/wangyb/genvict-imx8qxp_ls20c-release/sources/meta-fsl-bsp-release/imx/meta-bsp/recipes-kernel/linux/linux-imx/kernel-source/arch/arm64/configs/defconfig $(LINUX_DIR)/.config
	$(_SINGLE)$(KERNEL_MAKE) \
